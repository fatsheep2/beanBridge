...
export const presetConfigs: PresetConfig[] = [
  ...
  {
    provider: ProviderType.UnionPay,
    name: '银联基础配置',
    description: '银联交易记录的基础配置模板',
    config: {
      defaultMinusAccount: 'Assets:FIXME',
      defaultPlusAccount: 'Expenses:FIXME',
      defaultCurrency: 'CNY',
      rules: [
        ...
        {
          name: '自动转账还款',
          description: '人民币自动转账还款',
          txType: '自动转账还款',
          targetAccount: 'Liabilities:CreditCard',
          priority: 3
        },
        {
          name: '购物消费',
          description: '旗舰店购物归类为娱乐消费',
          peer: '旗舰店',
  ...
  {
    provider: ProviderType.Spdb,
    name: '浦发银行基础配置',
    description: '浦发银行交易记录的基础配置模板',
    config: {
      defaultMinusAccount: 'Assets:FIXME',
      defaultPlusAccount: 'Expenses:FIXME',
      defaultCurrency: 'CNY',
      rules: [
        {
          name: 'BTC交易',
          description: 'BTC/USDT交易对配置',
          item: 'BTC',
          type: '交易',
          txType: '买入',
          targetAccount: 'Assets:Crypto:BTC',
          methodAccount: 'Assets:Bank:SPDB',
          commissionAccount: 'Expenses:Commission',
          pnlAccount: 'Income:Trading',
          priority: 1
        }
      ]
    }
